    ...
    register(view) {
        ...
        for (let method of Object.getOwnPropertyNames(Object.getPrototypeOf(new view))) {
            if (Reflect.hasMetadata('unison:route', new view(), method)) {
                ...
                this.application[method_enum_1.MethodMap[routeMetadata.method || metadata.routes.method || method_enum_1.Method.GET]](view_util_1.GenerateURI(metadata.routes.baseUrl || '', routeMetadata.route), (request, response) => {
                ...
                this.logRoute(view_util_1.GenerateURI(metadata.routes.baseUrl || '', routeMetadata.route), routeMetadata.method || metadata.routes.method);
            }
        }
    }
    logRoute(url, method) {
